...
const MyInstallations = () => {
    ...
    const { handleUninstall, sortProductsByRating, installed, loading } = useProducts()
                    ...
                    <>
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <select
                                ...
                                className="px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-transparent bg-white"
                            >
